...
import cards.alice.redeemrequest.services.RedeemRequestService;
...
public class RedeemRequestController {
    ...
    @Value("${cards.alice.redeemrequest.web.controllers.path.base}${cards.alice.redeemrequest.web.controllers.path.redeem-request}")
    private String redeemRequestPath;

    private final RedeemRequestService redeemRequestService;

    @PostMapping(path = "${cards.alice.redeemrequest.web.controllers.path.redeem-request}")
    ...
    @GetMapping(path = "${cards.alice.redeemrequest.web.controllers.path.redeem-request}/{id}/exists")
    ...
    @GetMapping(path = "${cards.alice.redeemrequest.web.controllers.path.redeem-request}/{id}", produces = "application/json;charset=UTF-8")
    ...
    @PutMapping(path = "${cards.alice.redeemrequest.web.controllers.path.redeem-request}/{id}")
    ...
    @DeleteMapping(path = "${cards.alice.redeemrequest.web.controllers.path.redeem-request}/{id}")
    ...
    @GetMapping(path = "${cards.alice.redeemrequest.web.controllers.path.redeem-request.list}", produces = "application/json;charset=UTF-8")
